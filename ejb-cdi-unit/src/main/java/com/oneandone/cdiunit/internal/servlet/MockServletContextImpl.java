...
public class MockServletContextImpl implements ServletContext {
    ...
    /**
     * Sets a <code>RequestDispatcher</code> that will be returned when calling {@link #getRequestDispatcher} or {@link #getNamedDispatcher} with the
     * specified path or name. If no <code>RequestDispatcher</code> is set for the specified path, {@link #getRequestDispatcher} and
    ...
    /**
     * Sets a <code>ServletContext</code> that will be returned when calling {@link #getContext}
     * 
     * @param url
     *            the URL
     * @param context
     ...
     * @param value
     *            the value
     * @return <code>false</code> if the parameter was not set <code>true</code> otherwise
     */
    ...
    /*
     * public synchronized JspConfigDescriptor getJspConfigDescriptor() { return jspConfigDescriptor; } public synchronized void
     * setJspConfigDescriptor(JspConfigDescriptor jspConfigDescriptor) { this.jspConfigDescriptor = jspConfigDescriptor; }
     */
