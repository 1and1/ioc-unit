...
@CdiUnitServlet
public class LifecycleAwareRequestEjbCdiUnit implements HttpServletRequest {

	@Inject
	private EjbCdiUnitInitialListener listener;

	private HttpServletRequest delegate;

	public LifecycleAwareRequestEjbCdiUnit(
			EjbCdiUnitInitialListener listener,
