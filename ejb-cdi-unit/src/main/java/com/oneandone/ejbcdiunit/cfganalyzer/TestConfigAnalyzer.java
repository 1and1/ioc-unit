...
public abstract class TestConfigAnalyzer {
    ...
    protected static <T> Metadata<T> createMetadata(T value, String location) {
        if (weldBefore24) {
            return gettMetadataBefore24(value, location);
        }
        try {
    ...
    private static <T> Metadata<T> gettMetadataBefore24(T value, String location) {
        try {
