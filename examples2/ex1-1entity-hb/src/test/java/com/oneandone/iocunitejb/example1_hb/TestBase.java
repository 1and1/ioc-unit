...
public abstract class TestBase {
    ...
    public void canServiceInsertEntity1() {
        ...
        assertThat(id, is(1L));
        List<com.oneandone.iocunitejb.example1_hb.ExampleEntity1> resultList = entityManager.createQuery("Select e from ExampleEntity1 e", com.oneandone.iocunitejb.example1_hb.ExampleEntity1.class).getResultList();
        assertThat(resultList.size(), is(1));
        com.oneandone.iocunitejb.example1_hb.ExampleEntity1 entity1 = resultList.iterator().next();
    ...
    public void canReadTestDataUsingService() throws SystemException, NotSupportedException {
        ...
        List<com.oneandone.iocunitejb.example1_hb.ExampleEntity1> entities = new ArrayList<>();
        for (int i = 0; i < 10; i++) {
            final com.oneandone.iocunitejb.example1_hb.ExampleEntity1 entity1 = new com.oneandone.iocunitejb.example1_hb.ExampleEntity1(i, "string: " + i);
    ...
    public void canReadCommittedTestDataUsingServiceInRequiredNew()
        ...
        List<com.oneandone.iocunitejb.example1_hb.ExampleEntity1> entities = new ArrayList<>();
        for (int i = 0; i < 10; i++) {
            final com.oneandone.iocunitejb.example1_hb.ExampleEntity1 entity1 = new ExampleEntity1(i, "string: " + i);
            entities.add(entity1);
            entityManager.persist(entity1);
        }
