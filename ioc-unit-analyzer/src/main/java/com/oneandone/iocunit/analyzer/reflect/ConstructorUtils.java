...
public class ConstructorUtils {
    ...
    public static <T> Constructor<T> getMatchingAccessibleConstructor(final Class<T> cls,
        ...
        try {
            ...
            com.oneandone.iocunit.analyzer.reflect.MemberUtils.setAccessibleWorkaround(ctor);
            return ctor;
        ...
        for (Constructor<?> ctor : ctors) {
            // compare parameters
            if (com.oneandone.iocunit.analyzer.reflect.MemberUtils.isMatchingConstructor(ctor, parameterTypes)) {
                // get accessible version of constructor
                ctor = getAccessibleConstructor(ctor);
                if (ctor != null) {
                    com.oneandone.iocunit.analyzer.reflect.MemberUtils.setAccessibleWorkaround(ctor);
                    if (result == null || com.oneandone.iocunit.analyzer.reflect.MemberUtils.compareConstructorFit(ctor, result, parameterTypes) < 0) {
