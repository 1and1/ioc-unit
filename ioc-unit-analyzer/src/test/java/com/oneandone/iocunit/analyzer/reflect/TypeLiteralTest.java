...
import com.oneandone.iocunit.analyzer.reflect.TypeLiteral;
import com.oneandone.iocunit.analyzer.reflect.IocUnitTypeUtils;
import com.oneandone.iocunit.analyzer.reflect.Typed;
...
public class TypeLiteralTest {
    ...
    public void testBasic() {
        assertTrue(IocUnitTypeUtils.equals(String.class, new TypeLiteral<String>() {}.value));
        assertTrue(IocUnitTypeUtils.equals(IocUnitTypeUtils.parameterize(List.class, String.class),
    ...
    public void testTyped() {
        ...
        assertTrue(IocUnitTypeUtils.equals(String.class, stringType.getType()));
        final Typed<List<String>> listOfStringType = new TypeLiteral<List<String>>() {};
        assertTrue(IocUnitTypeUtils.equals(IocUnitTypeUtils.parameterize(List.class, String.class), listOfStringType.getType()));
    }
