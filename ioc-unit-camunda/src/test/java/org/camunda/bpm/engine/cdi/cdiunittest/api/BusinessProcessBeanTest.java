 ...
 */
package org.camunda.bpm.engine.cdi.cdiunittest.api;
...
public class BusinessProcessBeanTest extends CdiProcessEngineTestCase {
    ...
    public void testSaveTask() {
        ...
        String processInstanceId =
                businessProcess.startProcessByKey("businessProcessBeanTest", Collections.singletonMap("key", (Object) "value")).getId();
