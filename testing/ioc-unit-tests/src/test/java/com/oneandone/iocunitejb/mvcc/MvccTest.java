package com.oneandone.iocunitejb.mvcc;

import static com.oneandone.iocunitejb.mvcc.MvccTest.Mode.H2;
import static com.oneandone.iocunitejb.mvcc.MvccTest.Mode.MYSQL;
    ...
    public Connection createConnection()
        ...
        switch (mode) {
            case H2: {
                ...
                Connection conn = DriverManager.getConnection("jdbc:h2:mem:test;MODE=MySQL;MV_STORE=TRUE;DB_CLOSE_DELAY=1",
                        "sa", "");
                return conn;
            }
            case MYSQL: {
