...
public final class BeanProvider
{
     ...
     * {@link #getContextualReference(Class, Annotation...)}!</p>
     *
     ...
     * in {@link #getContextualReference(Class, boolean, Annotation...)}!</p>
     *
     *
     * @param beanManager the BeanManager to use
     * @param name the EL name of the bean
     ...
     * resolving is only done via {@link BeanManager#resolve(Set)} which we cannot use in this case!</p>
     *
     * @param type     the type of the bean in question
