...
public final class ConfigResolver
{
    ...
    /**
     * {@link #getPropertyValue(String)} which returns the provided default value if no configured value can
    ...
    /**
     * {@link #getPropertyAwarePropertyValue(String, String)} which returns the provided default
     ...
     * values that would be obtained by a call to {@link #getPropertyValue(String)}, that is, the value of the
     ...
     *
     * <p>If a Converter implements the {@link AutoCloseable} interface it will automatically
