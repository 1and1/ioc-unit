...
public class TestTransactionBase {
    ...
    private final TxType transactionAttribute;
    ...
    /**
     * Start a Transaction according to {@link TxType} as AutoCloseable to make sure at the
    ...
    /**
     * used according to AutoCloseable to handle the transaction at the end according to {@link TxType}
