        ...
        try {
            ...
            try {
               ...
               if (tmp == null)
                ...
                ConnectionDelegate connectionDelegate = entityManagerStore.getJpaProviderProvider().get().connectionBy(entityManagerStore);
                connectionDelegate.setJdbcSqlConverter(jdbcSqlConverter);
                connectionDelegate.setJpaProviderProvider(entityManagerStore.getJpaProviderProvider().get());
