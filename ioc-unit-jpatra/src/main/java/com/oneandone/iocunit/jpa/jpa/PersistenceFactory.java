...
import com.oneandone.iocunit.jpa.tra.TestTransaction;
import com.oneandone.iocunit.jpa.tra.TestTransactionException;


/**
 * The PersistenceFactory provides {@link EntityManager}s for tests.
 * Additionally this PersistenceFactory allows to initiate Transactions according to @see Transactional.TxType
...
public abstract class PersistenceFactory {
    ...
    public javax.inject.Provider<JpaProvider> getJpaProviderProvider() {
        return jpaProviderProvider;
    }

    @Inject
    javax.inject.Provider<JpaProvider> jpaProviderProvider;
     ...
     *
     * @param expectTransaction if no transaction is running throw transaction required exception
     ...
     */
    public TestTransaction transaction(Transactional.TxType transactionAttribute) {
     ...
     */
    public void transaction(Transactional.TxType transactionAttribute, TestClosure runnable) {
    ...
    public DataSource checkAndDoInFirstConnection(DataSource ds) {
