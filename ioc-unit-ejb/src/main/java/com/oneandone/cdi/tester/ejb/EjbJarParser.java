...
public class EjbJarParser {
    ...
    List<ApplicationExceptionDescription> applicationExceptionDescriptions = new ArrayList<>();


    public EjbJarParser(final URL url) {
        this.url = url;
    }

    public List<ApplicationExceptionDescription> invoke() throws IOException {
                        ...
                        if ("assembly-descriptor".equals(children.item(i).getNodeName())) {
                            ...
                            for (int j = 0; j < assemblyDescriptor.getLength(); j++) {
                                ...
                                if ("application-exception".equals(description.getNodeName())) {
                                    ...
                                    applicationExceptionDescriptions.add(applicationExceptionDescription);
                                }
                            }
                            break;
                        }
