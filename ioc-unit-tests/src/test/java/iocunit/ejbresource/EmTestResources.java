...
public class EmTestResources {
    public static class Datasource1PersistenceFactory extends TestPersistenceFactory {
    ...
    public static class Datasource3PersistenceFactory extends TestPersistenceFactory {
