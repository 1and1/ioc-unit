 ...
 */
@IocUnitResteasy
public class IocUnitHttpServletResponse implements HttpServletResponse {
    public final static String DATE_FORMAT_HEADER = "EEE, d MMM yyyy HH:mm:ss z";
    private PrintWriter writer;
    private IocUnitServletOutputStream outputStream;
    private Map headers;
    ...
    public IocUnitHttpServletResponse() {
        resetAll();
    }
    ...
    public void resetAll() {
        ...
        outputStream = new IocUnitServletOutputStream(characterEncoding);
        try {
    ...
    private String getDateString(long date) {
        ...
        SimpleDateFormat dateFormat = new SimpleDateFormat(DATE_FORMAT_HEADER, Locale.US);
