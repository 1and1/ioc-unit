 ...
 */
@IocUnitResteasy
public class IocUnitHttpServletRequest implements HttpServletRequest {
    ...
    private IocUnitServletInputStream bodyContent;
    ...
    public IocUnitHttpServletRequest() {
        resetAll();
    }
    ...
    public void resetAll() {
        ...
        bodyContent = new IocUnitServletInputStream(new byte[0]);
    ...
    public HttpSession getSession(boolean create) {
        ...
        if (create) {
            sessionCreated = true;
            if (session instanceof IocUnitHttpSession) {
                if (!((IocUnitHttpSession) session).isValid()) {
                    ((IocUnitHttpSession) session).resetAll();
                }
            }
        }
        return session;
    ...
    /**
     * Returns the map of <code>RequestDispatcher</code> objects. The specified path maps to the corresponding <code>RequestDispatcher</code> object.
     * 
    ...
    /**
     * Sets a <code>RequestDispatcher</code> that will be returned when calling {@link #getRequestDispatcher} with the specified path. If no
     * <code>RequestDispatcher</code> is set for the specified path, {@link #getRequestDispatcher} automatically creates a new one.
     * 
     * @param path
    ...
    public void setBodyContent(byte[] data) {
        bodyContent = new IocUnitServletInputStream(data);
    }
    ...
    public ServletContext getServletContext() {
        ...
        throw new RuntimeException("Not implemented in IocUnitResteasy");
    }
