...
/**
 * Signifies classes from the "system under test" which may be used to satisfy injection requirements when CDI gets started. The classes are defined
 * as contained as part of the classpath-element of the classes provided in value. May clash with alternatives.
 */
