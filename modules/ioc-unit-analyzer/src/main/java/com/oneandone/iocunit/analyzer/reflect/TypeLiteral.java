...
public abstract class TypeLiteral<T> implements Typed<T> {
    ...
    private static final TypeVariable<Class<com.oneandone.iocunit.analyzer.reflect.TypeLiteral>> T = com.oneandone.iocunit.analyzer.reflect.TypeLiteral.class.getTypeParameters()[0];
    ...
    protected TypeLiteral() {
        this.value =
            Validate.notNull(IocUnitTypeUtils.getTypeArguments(getClass(), com.oneandone.iocunit.analyzer.reflect.TypeLiteral.class).get(T),
                "%s does not assign type parameter %s", getClass(), IocUnitTypeUtils.toLongString(T));

        this.toString = String.format("%s<%s>", com.oneandone.iocunit.analyzer.reflect.TypeLiteral.class.getSimpleName(), IocUnitTypeUtils.toString(value));
    }
    ...
    public final boolean equals(final Object obj) {
        ...
        if (!(obj instanceof com.oneandone.iocunit.analyzer.reflect.TypeLiteral)) {
            return false;
        }
        final com.oneandone.iocunit.analyzer.reflect.TypeLiteral<?> other = (com.oneandone.iocunit.analyzer.reflect.TypeLiteral<?>) obj;
        return IocUnitTypeUtils.equals(value, other.value);
    }
